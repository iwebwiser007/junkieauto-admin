    ...
    public function show_make(Request $req){
        ...
        if($req->make_status == '1'){
            ...
            if($auction == '0'){
                ...
                $msg = 'This make is alreday in use, so you can not block this make';
            }
    ...
    public function show_model(Request $req, $id){
        ...
        if($req->model_status == '1'){
            ...
            if($auction == '0'){
                ...
                $msg = 'This model is alreday in use, so you can not block this model';
            }
        ...
        return redirect('models/'.$id)->with('msg',$msg);
    }
