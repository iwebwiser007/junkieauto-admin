                    ...
                    <div class="card">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                          ...
                          <div class="action-buttons">
                                ...
                                data-bs-target="#exampleModalCenter">Add Commission<i class="fas fa-plus-circle ms-2"></i></button>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body mt-3">
          <div class="mb-3">
              <form action="{{url('add_commission')}}" method="post" id="add_commission">
                  @csrf
                    <label class="form-label" for="commission">Add Commission</label> 
                    ...
                    <div class="modal-btn mt-4 text-center">
                      ...
                      <button class="btn btn-primary" type="button" onclick="add_commission()">Save</button>
