...
<div class="page-body dashboard-2-main">
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-header">
                        <div class="header-top d-sm-flex justify-content-between align-items-center">
                            ...
                            <div class="center-content">
                                <p class="d-sm-flex align-items-center"><span class="m-r-10">${{$total_earn}}</span><i
                                        class="toprightarrow-primary fa fa-arrow-up m-r-10"></i> {{ ($earn_result > 0) ?  number_format($earn_result,2) : '0' }}% More Than Last Month
                                </p>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="header-top d-sm-flex justify-content-between align-items-center">
                            <h5>Auction Chart </h5>
                            <div class="center-content">
                                <p class="d-sm-flex align-items-center"><span class="m-r-10">{{$total_auction}}</span><i
                                        class="toprightarrow-primary fa fa-arrow-up m-r-10"></i> {{ ($auction_result > 0) ?  number_format($seller_result,2) : '0' }}% More Than Last Month
                                </p>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="header-top d-sm-flex justify-content-between align-items-center">
                            <h5>Seller Chart </h5>
                            <div class="center-content">
                                <p class="d-sm-flex align-items-center"><span class="m-r-10">{{$total_seller}}</span><i
                                        class="toprightarrow-primary fa fa-arrow-up m-r-10"></i> {{ ($seller_result > 0) ?  number_format($seller_result,2) : '0' }}% More Than Last Month
                                </p>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="header-top d-sm-flex justify-content-between align-items-center">
                            <h5>Bids Chart </h5>
                            <div class="center-content">
                                <p class="d-sm-flex align-items-center"><span class="m-r-10">{{$total_bids}}</span><i
                                        class="toprightarrow-primary fa fa-arrow-up m-r-10"></i> {{ ($bids_result > 0) ?  number_format($bids_result,2) : '0' }}% More Than Last Month
                                </p>
                            </div>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="header-top d-sm-flex justify-content-between align-items-center">
                            <h5>Top Sellers</h5>
                            <div class="center-content">
                                <p class="d-sm-flex align-items-center"><span class="m-r-10">{{$total_seller}} Sellers</span><i
                                        class="toprightarrow-primary fa fa-arrow-up m-r-10"></i>{{ ($seller_result > 0) ?  number_format($seller_result,2) : '0' }}% More Than Last Year
                                </p>
                            </div>
                            {{-- <div class="setting-list">
                                <ul class="list-unstyled setting-option">
                                        ...
                                        <div class="owl-carousel-16 owl-carousel owl-theme">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="top-dealerbox text-center">
                                                        <!--<img class="card-img-top"
                                                            src="{{asset('image/dashboard-2/1.png')}}" alt="..."> -->
                                            ...
                                            <div class="item">
                                                <div class="card">
                                                     <div class="top-dealerbox text-center">
                                                         <!--<img class="card-img-top"
                                                            src="{{asset('image/dashboard-2/8.png')}}" alt="..."> -->
                                                        <h6>Johnson allon</h6>
                                            ...
                                            <div class="item">
                                                <div class="card">
                                                    <div class="top-dealerbox text-center">
                                                        <!-- <img class="card-img-top"
                                                            src="{{asset('image/dashboard-2/3.png')}}" alt="..."> -->
                                                        <h6>williams reed</h6>
                                            ...
                                            <div class="item">
                                                <div class="card">
                                                    <div class="top-dealerbox text-center">
                                                        <!--<img class="card-img-top"
                                                            src="{{asset('image/dashboard-2/4.png')}}" alt="..."> -->
                                                        <h6> Jones king</h6>
                                        ...
                                        <div class="owl-carousel-16 owl-carousel owl-theme">
                                            <div class="item">
                                                <div class="card">
                                                    <div class="top-dealerbox text-center">
                                                        <!-- <img class="card-img-top"
                                                            src="{{asset('image/dashboard-2/5.png')}}" alt="..."> -->
                                                        <h6>Brown davis</h6>
                                            ...
                                            <div class="item">
                                                <div class="card">
                                                    <div class="top-dealerbox text-center">
                                                        <!-- <img class="card-img-top"
                                                            src="{{asset('image/dashboard-2/6.png')}}" alt="..."> -->
                                                        <h6>Wilson Hill</h6>
                                            ...
                                            <div class="item">
                                                <div class="card">
                                                    <div class="top-dealerbox text-center">
                                                        <!-- <img class="card-img-top"
                                                            src="{{asset('image/dashboard-2/7.png')}}" alt="..."> -->
                                                        <h6>Anderson ban</h6>
                            ...
                            <pre><code class="language-html" id="top-dealer">&lt;div class="card"&gt;
                                ...
                                &lt;div class="card-body"&gt;
                                    ...
                                    &lt;div class="item"&gt;
                                        ...
                                        &lt;div class="col-sm-3"&gt;
                                            &lt;div class="card"&gt;
                                                &lt;div class="top-dealerbox text-center"&gt;&lt;img class="card-img-top" src="{{asset('image/dashboard-2/1.png')}}" alt="..."&gt;
                                                &lt;h6&gt;Thompson lee&lt;/h6&gt;
                                        ...
                                        &lt;div class="col-sm-3"&gt;
                                            &lt;div class="card"&gt;
                                                &lt;div class="top-dealerbox text-center"&gt;&lt;img class="card-img-top" src="{{asset('image/dashboard-2/8.png')}}" alt="..."&gt;
                                                &lt;h6&gt;johnson allon&lt;/h6&gt;
                                        ...
                                        &lt;div class="col-sm-3"&gt;
                                            &lt;div class="card"&gt;
                                                &lt;div class="top-dealerbox text-center"&gt;&lt;img class="card-img-top" src="{{asset('image/dashboard-2/3.png')}}" alt="..."&gt;
                                                &lt;h6&gt;williams reed&lt;/h6&gt;
                                        ...
                                        &lt;div class="col-sm-3"&gt;
                                            &lt;div class="card"&gt;
                                                &lt;div class="top-dealerbox text-center"&gt;&lt;img class="card-img-top" src="{{asset('image/dashboard-2/5.png')}}" alt="..."&gt;
                                                &lt;h6&gt;Brown davis&lt;/h6&gt;
                                        ...
                                        &lt;div class="col-sm-3"&gt;
                                            &lt;div class="card"&gt;
                                                &lt;div class="top-dealerbox text-center"&gt;&lt;img class="card-img-top" src="{{asset('image/dashboard-2/6.png')}}" alt="..."&gt;
                                                &lt;h6&gt;Wilson Hill&lt;/h6&gt;
                                        ...
                                        &lt;div class="col-sm-3"&gt;
                                            &lt;div class="card"&gt;
                                                &lt;div class="top-dealerbox text-center"&gt;&lt;img class="card-img-top" src="{{asset('image/dashboard-2/7.png')}}" alt="..."&gt;
                                                &lt;h6&gt;Anderson ban&lt;/h6&gt;
            ...
            <div class="col-xl-12 col-md- des-xl-100 box-col-12">
                <div class="row">
                                ...
                                <div class="round-progress knob-block text-center">
                                    <div class="progress-circle">
                                        <input class="knob1" data-width="50" data-height="70" data-thickness=".3"
                                            data-fgcolor="#24695c" data-linecap="round" data-angleoffset="0" value="60">
                                    </div>
                                    <h5>$4,55,462</h5>
                                    <p>Our Annual Income</p>
                                </div>
                    ...
                    {{-- <div class="col-xl-6 box-col-6 top-sell-sec">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media"><img class="img-fluid" src="{{asset('')}}image/dashboard-2/9.png" alt="">
                                ...
                                <div class="code-box-copy">
                                    ...
                                    <pre><code class="language-html" id="top-selling-product">&lt;div class="card"&gt;
                                        ...
                                        &lt;/div&gt;
                                        &lt;div class="card-body"&gt;
                                            &lt;div class="media"&gt;&lt;img class="img-fluid" alt="" src="{{asset('')}}image/dashboard-2/9.png"&gt;
                    ...
                    {{-- <div class="col-xl-6 box-col-6">
                        <div class="card target-sec">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="animat-block"><i class="fa fa-times close1"></i><i
                                        class="fa fa-times close2"></i><i class="fa fa-times close3"></i>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body d-block">
                                    ...
                                    <h5>James just like your product <i
                                            class="fa fa-circle circle-dot-primary pull-right"></i>
                                    </h5>
                                    <p>Quisque a consequat ante Sit amet magna at volutapt.</p>
                                    <ul class="timeline-pro">
                                        <li> <img class="img-fluid" src="{{asset('')}}image/dashboard-2/11.png"
                                                alt="Product-1"></li>
                                        <li> <img class="img-fluid" src="{{asset('')}}image/dashboard-2/10.png"
                                                alt="Product-2"></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <pre><code class="language-html" id="activity-timeline">   &lt;div class="card"&gt;
                                ...
                                &lt;div class="chart-main activity-timeline update-line"&gt;
                                    ...
                                    &lt;div class="activity-dot-primary"&gt;&lt;/div&gt;
                                        ...
                                        &lt;p&gt;Quisque a consequat ante Sit amet magna at volutapt.&lt;/p&gt;
                                        &lt;ul class="timeline-pro"&gt;
                                            &lt;li&gt; &lt;img class="img-fluid" src="{{asset('')}}image/dashboard-2/11.png" alt="Product-1"&gt;&lt;/li&gt;
                                            &lt;li&gt; &lt;img class="img-fluid" src="{{asset('')}}image/dashboard-2/10.png" alt="Product-2"&gt;&lt;/li&gt;
                                        &lt;/ul&gt;
                                        &lt;/div&gt;
                                    &lt;/div&gt;
                                    &lt;div class="media"&gt;
