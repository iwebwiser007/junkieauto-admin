                                ...
                                <div
                                  ...
                                  <div class="follow mt-3">
                                    <ul class="follow-list">
                                      <li>
                                        <div class="follow-num counter text-center">450</div><span>Buy Bid</span>
                                      </li>

                                      <li>
                                        <div class="follow-num counter text-center">500</div><span>Won Bid</span>
                                      </li>

                                      <li>
                                        <div class="follow-num counter text-center">50</div><span>Lost bid</span>
                                      </li>

                                      <li>
                                        <div class="follow-num counter text-center">20</div><span>Active Bids</span>
                                      </li>
                                    </ul>
                                  </div>
                                </div>
                          ...
                          <ul class="nav nav-tabs border-tab nav-primary mb-3" id="info-tab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" id="info-home-tab" data-bs-toggle="tab" href="#info-home"
                                role="tab" aria-controls="info-home" aria-selected="true">All Bids</a>
                            </li>

                            <li class="nav-item">
                              <a class="nav-link" id="profile-info-tab" data-bs-toggle="tab" href="#info-profile"
                                role="tab" aria-controls="info-profile" aria-selected="false">Buy Bids</a>
                            </li>

                            <li class="nav-item"><a class="nav-link" id="contact-info-tab" data-bs-toggle="tab"
                                href="#info-contact" role="tab" aria-controls="info-contact" aria-selected="false">Won
                                Bids</a>
                            </li>

                            <li class="nav-item"><a class="nav-link" id="contact-info-tab" data-bs-toggle="tab"
                                href="#info-contact-1" role="tab" aria-controls="info-contact"
                                aria-selected="false">Lost Bids
                              </a>
                            </li>

                            <li class="nav-item"><a class="nav-link" id="contact-info-tab" data-bs-toggle="tab"
                                href="#info-contact-2" role="tab" aria-controls="info-contact"
                                aria-selected="false">Active Bids</a>
                            </li>
                          </ul>
